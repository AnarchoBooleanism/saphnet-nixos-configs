  ...
  outputs =
    {
      ...
      nixosConfigurations = {
        ...
        "docker-host-core" = nixpkgs.lib.nixosSystem { # Docker host for reverse proxy and various web services
          specialArgs = {inherit inputs outputs versionLock;}; # versionLock is particularly important here!
          system = "x86_64-linux";
          modules = [
